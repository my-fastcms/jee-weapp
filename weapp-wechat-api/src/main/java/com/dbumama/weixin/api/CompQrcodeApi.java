...
public class CompQrcodeApi
{
    ...
    public static ApiResult createTemporary(int expireSeconds, int sceneId, String accessToken) {
        ...
        return create(JsonUtils.toJson(params), accessToken);
    }
     ...
     * @return ApiResult 二维码信息
     */
    public static ApiResult createTemporaryStr(int expireSeconds, String sceneId, String accessToken) {
        Map<String, Object> params = new HashMap<String, Object>();
        params.put("expire_seconds", expireSeconds);
