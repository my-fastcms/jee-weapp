...
public class CompMediaApi {
	 ...
	 * @return ApiResult 
	 */
	public static ApiResult uploadMedia(String accessToken, MediaType mediaType, File file) {
		String url = upload_url + accessToken + "&type=" + mediaType.get();
	 ...
	 * @return
	 */
	public static ApiResult uploadVideo(String accessToken, String mediaId, String title, String description) {
		String url = uploadVideoUrl + accessToken;
	 ...
	 * @return MediaFile
	 */
	public static MediaFile getMedia(String accessToken, String media_id) {
		String url = get_url + accessToken + "&media_id=" + media_id;
	 ...
	 * @return ApiResult
	 */
	public static ApiResult addNews(String accessToken,List<MediaArticles> mediaArticles) {
	 ...
	 * @return ApiResult
	 */
	public static ApiResult uploadImg(String accessToken,File imgFile) {
		String url = uploadImgUrl + accessToken;
	 ...
	 * @return ApiResult
	 */
	public static ApiResult addMaterial(String accessToken,MediaType mediaType,File file) {
		String url = addMaterialUrl + accessToken+"&type=" + mediaType.get();;
	 ...
	 * @return ApiResult
	 */
	public static ApiResult addMaterial(String accessToken, File file, String title, String introduction) {
		String url = addMaterialUrl + accessToken;
	 ...
	 */
	public static ApiResult getMaterial(String accessToken, String media_id) {
		String url = get_material_url + accessToken;
	 ...
	 */
	public static ApiResult delMaterial(String accessToken, String media_id) {
		String url = del_material_url + accessToken;
	 ...
	 * @return ApiResult 返回信息
	 */
	public static ApiResult updateNews(String accessToken, String media_id, int index, MediaArticles mediaArticles) {
		String url = update_news_url + accessToken;
	 ...
	 * @return ApiResult 返回信息
	 */
	public static ApiResult getMaterialCount(String accessToken) {
		String url = get_materialcount_url + accessToken;
	 ...
	 * @return ApiResult 返回信息
	 */
	public static ApiResult batchGetMaterial(MediaType mediaType,String accessToken,int offset, int count) {
		String url = batchget_material_url + accessToken;
	...
	public static void main(String[] args) {
		...
		MediaFile mf = CompMediaApi.getMedia("", mediaId);
		...
		//ApiResult aResult = CompMediaApi.uploadImg(f);
//		f.delete();
