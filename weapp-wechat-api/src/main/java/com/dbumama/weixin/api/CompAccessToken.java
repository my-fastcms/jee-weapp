...
import com.dbumama.market.base.ReturnCode;
import com.dbumama.market.utils.JsonUtils;
import com.dbumama.weixin.utils.RetryUtils.ResultCheck;

/**
 * 封装 access_token
 */
@SuppressWarnings("unchecked")
public class CompAccessToken implements ResultCheck, Serializable {
    ...
    public CompAccessToken(String jsonStr) {
        this.json = jsonStr;

        try {
            Map<String, Object> temp = JsonUtils.parse(jsonStr, Map.class);
            access_token = (String) temp.get("component_access_token");
