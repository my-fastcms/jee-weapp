 ...
 *
 */
public class SetAuthorizerOptionApi {

	static final String url = "https://api.weixin.qq.com/cgi-bin/component/api_set_authorizer_option?component_access_token=";
	 ...
	 * @return
	 */
	public static ApiResult getAuthorOption(String compAccessToken, String authAppId, String optionName, String optionValue){
