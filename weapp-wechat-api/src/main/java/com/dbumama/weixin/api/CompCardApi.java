...
public class CompCardApi {
	 ...
	 * @return
	 */
	public static ApiResult batchGetCards(String accessToken, String authAppId, String jsonStr){
		String jsonResult = HttpUtils.post(batchget + accessToken+"&appid=", jsonStr);
	 ...
	 * @return
	 */
	public static ApiResult getCard(String accessToken, String authAppId, String jsonStr){
		String jsonResult = HttpUtils.post(getCard + accessToken+"&appid=", jsonStr);
		return new ApiResult(jsonResult);
	}
	 ...
	 * @return
	 */
	public static ApiResult createCard(String accessToken, String authAppId, String jsonStr) {
		String jsonResult = HttpUtils.post(createCard + accessToken+ "&appid="+authAppId, jsonStr);
		return new ApiResult(jsonResult);
	}
	 ...
	 * @return
	 */
	public static ApiResult updateCard(String accessToken, String authAppId, String jsonStr) {
		String jsonResult = HttpUtils.post(updateCard + accessToken+ "&appid="+authAppId, jsonStr);
		return new ApiResult(jsonResult);
	}
	 ...
	 * 
	 */
	public static ApiResult memberCard(String accessToken, String authAppId, String jsonStr){
		String jsonResult = HttpUtils.post(memberCard + accessToken+ "&appid="+authAppId, jsonStr);
		return new ApiResult(jsonResult);
	}
	 ...
	 * @return
	 */
	public static ApiResult memberCardInfo(String accessToken, String authAppId, String jsonStr){
		String jsonResult = HttpUtils.post(memberCardInfo + accessToken+ "&appid="+authAppId, jsonStr);
		return new ApiResult(jsonResult);
	}
	 ...
	 */
	public static ApiResult updateUser(String accessToken, String authAppId, String jsonStr){
		String jsonResult = HttpUtils.post(updateUser + accessToken+ "&appid="+authAppId, jsonStr);
		return new ApiResult(jsonResult);
	}
