...
public class UnifiedOrderApi extends PayApi{
	...
	protected BaseResData getRespone(Element root) {
		...
		unifiedOrderResData.setCode_url(root.elementText("code_url"));
	...
	public static void main(String[] args) {
	  ...
	  **/
		...
		//NATIVE 下单接口
		UnifiedOrderAppReqData unifiedOrderAppReqData = new UnifiedOrderAppReqData("appId", "mchId", "mchKey", "testOrder", 
