...
public class SendredpackReqData extends BaseReqCommData{
	...
	private String scene_id;	//发放红包使用场景，红包金额大于200或者小于1元时必传
	...
	public SendredpackReqData(
		...
		this(mch_id, mchSecKey, mch_billno, "", wxappid, "", send_name, re_openid, total_amount, total_num, wishing, client_ip, act_name, remark, "", scene_id);
	}
	...
	public SendredpackReqData(
		...
		this(mch_id, mchSecKey, mch_billno, "", wxappid, "", send_name, re_openid, total_amount, total_num, wishing, client_ip, act_name, remark, "", "");
	}
