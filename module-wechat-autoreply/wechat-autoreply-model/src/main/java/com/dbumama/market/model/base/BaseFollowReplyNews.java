...
public abstract class BaseFollowReplyNews<M extends BaseFollowReplyNews<M>> extends WxmModel<M> implements IBean {
	...
	public M setFollowConfigId(java.lang.Long followConfigId) {
		set("follow_config_id", followConfigId);
		return (M)this;
	}
	
	public java.lang.Long getFollowConfigId() {
		return getLong("follow_config_id");
	}
