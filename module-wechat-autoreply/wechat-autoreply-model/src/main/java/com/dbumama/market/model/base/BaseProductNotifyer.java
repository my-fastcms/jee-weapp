...
public abstract class BaseProductNotifyer<M extends BaseProductNotifyer<M>> extends WxmModel<M> implements IBean {
	...
	public M setProductConfigId(java.lang.Long productConfigId) {
		set("product_config_id", productConfigId);
		return (M)this;
	}
	
	public java.lang.Long getProductConfigId() {
		return getLong("product_config_id");
	}
