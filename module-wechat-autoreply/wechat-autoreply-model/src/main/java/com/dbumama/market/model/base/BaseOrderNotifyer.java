...
public abstract class BaseOrderNotifyer<M extends BaseOrderNotifyer<M>> extends WxmModel<M> implements IBean {
	...
	public M setOrderConfigId(java.lang.Long orderConfigId) {
		set("order_config_id", orderConfigId);
		return (M)this;
	}
	
	public java.lang.Long getOrderConfigId() {
		return getLong("order_config_id");
	}
