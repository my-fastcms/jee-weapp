function addSpecification(){
	var params={};
	obz.addSpecification(params, function (obj) {
		 var jarr=obj.data;
		 for (var i = 0; i < jarr.length; i++) {
			var specificationValues=jarr[i].specificationValues;
			var specification=jarr[i].specification;
        ...
        Creat_Table: function () {
            ...
            if (bCheck == true) {
              ...
              //创建表头
                ...
                //创建规格表
                $("#createTable").html("");
                var table = $("<table id=\"process\" style=\"font-size: 14px;\" class=\"table table-striped table-bordered\"></table>");
              ...
              //物流重量
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var td1 = $("<td class=\"col-md-2\"><span  class=\"requiredField\"></span><input id=\"priceId"+index+"\" name=\"price_s\" class=\"price form-control\" type=\"text\" value=\"\" onkeyup=\"checkNum(this)\"><label class=\"price_error_msg\" style=\"color:red;\"></label></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td class=\"col-md-2\"><span class=\"requiredField\"></span><input id=\"stockId"+index+"\" name=\"stock_s\" class=\"stocks form-control\" type=\"text\" value=\"\" onkeyup=\"sumNum();checkNum(this)\"><label class=\"stock_error_msg\" style=\"color:red;\"></td>");
                        td2.appendTo(tr);
                    });
                }
                //结束创建Table表
