...
public abstract class BaseWeimoApp<M extends BaseWeimoApp<M>> extends WxmModel<M> implements IBean {
	...
	public M setAppClientid(java.lang.String appClientid) {
		set("app_clientid", appClientid);
		return (M)this;
	}
	
	public java.lang.String getAppClientid() {
		return getStr("app_clientid");
	}
