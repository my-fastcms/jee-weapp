...
public abstract class BaseMedia<M extends BaseMedia<M>> extends WxmModel<M> implements IBean {
	...
	public M setViewUrl(java.lang.String viewUrl) {
		set("view_url", viewUrl);
		return (M)this;
	}
	
	public java.lang.String getViewUrl() {
		return getStr("view_url");
	}
