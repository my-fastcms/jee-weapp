...
public abstract class BasePayee<M extends BasePayee<M>> extends WxmModel<M> implements IBean {
	...
	public M setPayeeName(java.lang.String payeeName) {
		set("payee_name", payeeName);
		return (M)this;
	}
	
	public java.lang.String getPayeeName() {
		return getStr("payee_name");
	}
