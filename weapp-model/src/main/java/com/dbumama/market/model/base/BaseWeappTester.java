...
public abstract class BaseWeappTester<M extends BaseWeappTester<M>> extends WxmModel<M> implements IBean {
	...
	public M setWxUser(java.lang.String wxUser) {
		set("wx_user", wxUser);
		return (M)this;
	}
	
	public java.lang.String getWxUser() {
		return getStr("wx_user");
	}
