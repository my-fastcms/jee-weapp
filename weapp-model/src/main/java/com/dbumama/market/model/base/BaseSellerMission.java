...
public abstract class BaseSellerMission<M extends BaseSellerMission<M>> extends WxmModel<M> implements IBean {
	...
	public M setMission(java.math.BigDecimal mission) {
		set("mission", mission);
		return (M)this;
	}
	
	public java.math.BigDecimal getMission() {
		return get("mission");
	}
