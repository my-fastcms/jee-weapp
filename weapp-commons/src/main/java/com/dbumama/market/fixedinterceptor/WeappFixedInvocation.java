 ...
 */
public class WeappFixedInvocation extends Invocation {

    private Invocation origin;


    private FixedInterceptor[] inters = WeappFixedInterceptors.me().all();
    private int index = 0;


    public WeappFixedInvocation(Invocation invocation) {
