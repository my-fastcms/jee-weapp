package com.dbumama.market.handler;

import com.dbumama.market.fixedinterceptor.WeappFixedInvocation;
...
public class WeappActionHandler extends ActionHandler {
...
//            controller.init(request, response, urlPara[0]);
    ...
    private void invokeInvocation(Invocation inv) {
        new WeappFixedInvocation(inv).invoke();
    }
