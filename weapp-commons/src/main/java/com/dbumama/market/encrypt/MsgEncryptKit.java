package com.dbumama.market.encrypt;
...
public class MsgEncryptKit {
     ...
     * @return
     */
    public static String encryptComp(String msg, String timestamp, String nonce) {
        try {
     ...
     * @return
     */
    public static String decryptComp(String encryptedMsg, String timestamp, String nonce, String msgSignature) {
        try {
            ApiConfig ac = Jboot.config(ApiConfig.class);
