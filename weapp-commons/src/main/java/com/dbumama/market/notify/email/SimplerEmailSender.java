...
public class SimplerEmailSender extends Authenticator implements IEmailSender {
	...
	private WxmEmailConfig emailConfig = Jboot.config(WxmEmailConfig.class);
	
	private void init() {
		this.host = emailConfig.getEmailHost();// "smtp.qq.com";
		this.name = emailConfig.getEmailUsername();// "198819880@qq.com";
		this.password = emailConfig.getEmailPassword();
		this.useSSL = emailConfig.getEmailUsessl();
	}
