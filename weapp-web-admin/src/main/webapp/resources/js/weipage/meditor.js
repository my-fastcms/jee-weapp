...
//init propPanel value
     ...
     $('#text-href-link').change(function(){
    	 var value= $(this).val();
    	 if(value=='4'){
			 $('#text-href-weipageid-div').show();
		 }else {
			 $('#text-href-weipageid-div').hide();
		 }
    	 if(value=='9999'){
     ...
     $('#text-href-weipageid').change(function(){
    	 var value= $(this).val();
    	 changeValueHandle("text-href","weipageId",value);
     });
     ...
     function initTextHerfPanel(data){
    	 ...
    	 $proppanel.find("#text-href-weipageid").find("option[value='"+data.weipageId+"']").prop("selected",true);
    	 if(data.link=='4'){
			 $('#text-href-weipageid-div').show();
		 }else {
			 $('#text-href-weipageid-div').hide();
	...
	function addGroupTitle(data){
     ...
     $("#choices").on("change",'.ad-href',function(){
    	 ...
    	 var imgId= $(this).data("id");
    	 if(value=='4'){
			 $('#text-href-weipage-'+imgId).show();
		 }else {
			 $('#text-href-weipage-'+imgId).hide();
		 }
    	 if(value=='custom'){
     ...
     $("#choices").on("change",'.text-weipageid',function(){
    	 var value= $(this).val();
    	 var imgId= $(this).data("id");
    	 var $com=$mobilebox.find(".editing");
    	 if($com && $com.data('componentType')=="ad"){
    		 ...
    		 for(i=0;i<data.imgList.length;i++){
    	    	   if((imgId+"")==(data.imgList[i].id+"")){
    	    		 data.imgList[i].weipageId=value;
    	    	   }
    	       }
    		 var html= getComponentHtml(type,data);
    		 $com.find('.component').html(html);
   ...
   //重新上传
     ...
     function addChoiceImage(data){
    	 ...
    	 for(r=0;r<data.imgList.length;r++){
    		 ...
    		 if(data.imgList[r].weipageId){
    			 $("#text-href-weipage-"+data.imgList[r].id).show();
    		 }
    		 $proppanel.find("#text-href-weipageid-"+data.imgList[r].id).find("option[value='"+data.imgList[r].weipageId+"']").prop("selected",true);
     ...
     $("#choicesHref").on("change",'.img-weipageid',function(){
    	 var value= $(this).val();
    	 var imgId= $(this).data("id");
    	 var $com=$mobilebox.find(".editing");
    	 if($com && $com.data('componentType')=="img-href"){
     ...
     $("#choicesHref").on("change",'.img-href',function(){
    	 ...
    	 var imgId= $(this).data("id");
    	 if(value=='4'){
			 $('#img-href-weipage-'+imgId).show();
		 }else {
			 $('#img-href-weipage-'+imgId).hide();
		 }
    	 if(value=='custom'){
     ...
     function addChoiceImageHref(data){
    	 ...
    	 for(var r=0;r<data.imgList.length;r++){
    		 if(r<=3){
        		 ...
        		 if(data.imgList[r].weipageId){
        			 $("#img-href-weipage-"+data.imgList[r].id).show();
        		 }
        		 $proppanel.find("#img-href-weipageid-"+data.imgList[r].id).find("option[value='"+data.imgList[r].weipageId+"']").prop("selected",true);
	...
	var validRules={
            ...
            "text-href":{required:[{field:"title",msg:"导航文字不能空",id:"text-href-title"},
                         ...
                         ref_required:[{field:"outurl",msg:"链接URL不能空",id:"text-href-outurl",refId:"text-href-link",refField:"link",refValue:"9999"},
                        	 {field:"weipageId",msg:"必选",id:"text-href-weipageid",refId:"text-href-link",refField:"link",refValue:"4"}]          
            		}        
	};
