...
public class InvitecodeController extends BaseAdminController{
	...
	public void stat(){
		render("incode_stat.html");
	}
	
	public void statlist(){
		rendSuccessJson(sellerUserService.getPageSellerByIncode(getPageNo(), getPageSize(), getSellerUser().getMyInviteCode(), getPara("phone")));
	}
	...
	public void cashrcd(){
		render("incode_mission_rcd.html");
	}
	
	public void cashrcdlist(){
		rendSuccessJson(invitecodeRuleService.getUserCashRcd(getPageNo(), getPageSize(), getSellerId(), getParaToInt("status")));
	}
